...
from bumblebee_problem_value_doe import UrbanPollinator
...
if __name__ == "__main__" :
    ...
    file_handler = logging.FileHandler('inspyred_value_doe.log', mode='w')
    ...
    df.to_csv('final_pop_value_doe.csv', index=False)
